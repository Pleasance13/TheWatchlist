...
function advancedFilterPanel(){
 ...
 <div class="filter-control"><details class="filter-dropdown"><summary>Genre(s) ▾ ${selected.length?`<span class="filter-count">${selected.length}</span>`:""}</summary><div class="filter-menu"><div class="filter-options">${multi(genres,selected,"toggleGenre")}</div></div></details>${filterChip("Genre(s)","genreFilters")}</div>
