...
function syncHeaderPrism(){const logo=document.querySelector(".brand-logo"),avatar=document.querySelector(".topbar .user"),prism=document.querySelector(".header-prism");if(!logo||!avatar||!prism)return;const l=logo.getBoundingClientRect(),u=avatar.getBoundingClientRect();const left=l.right-l.width*.139,right=u.left-24,width=Math.max(0,right-left);prism.style.setProperty("position","fixed","important");prism.style.setProperty("left",left+"px","important");prism.style.setProperty("right","auto","important");prism.style.setProperty("top",l.top+"px","important");prism.style.setProperty("bottom","auto","important");prism.style.setProperty("width",width+"px","important");prism.style.setProperty("height",l.height+"px","important");prism.style.setProperty("transform","none","important");prism.style.setProperty("margin","0","important");prism.style.setProperty("--prism-height",l.height+"px");if(window.__watchlistPrismIntroRunning&&window.__watchlistPrismIntroElement===prism)return;if(!window.__watchlistPrismIntroPlayed){window.__watchlistPrismIntroPlayed=true;window.__watchlistPrismIntroRunning=true;window.__watchlistPrismIntroElement=prism;prism.style.clipPath="inset(0 100% 0 0)";prism.style.webkitClipPath="inset(0 100% 0 0)";prism.getBoundingClientRect();if(typeof prism.animate==="function"){const intro=prism.animate([{clipPath:"inset(0 100% 0 0)"},{clipPath:"inset(0 0 0 0)"}],{duration:1350,easing:"cubic-bezier(.65,0,.35,1)",fill:"forwards"});intro.onfinish=()=>{if(window.__watchlistPrismIntroElement===prism){prism.style.clipPath="inset(0 0 0 0)";prism.style.webkitClipPath="inset(0 0 0 0)";window.__watchlistPrismIntroRunning=false;window.__watchlistPrismIntroElement=null;}intro.cancel();};}else{prism.style.clipPath="inset(0 0 0 0)";prism.style.webkitClipPath="inset(0 0 0 0)";window.__watchlistPrismIntroRunning=false;window.__watchlistPrismIntroElement=null;}}else{prism.style.clipPath="inset(0 0 0 0)";prism.style.webkitClipPath="inset(0 0 0 0)";}}
